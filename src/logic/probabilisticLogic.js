...
export function probabilisticPixelStyle(number) {
    return `background-color: ${color[number]}`;
}

export default {
    evolve: probabilisticEvolve,
    generatePixel: probabilisticGeneratePixel,
    startPixels: probabilisticRandomPixels,
    pixelStyle: probabilisticPixelStyle,
};
